...
enum { SA_KICK = 0, SA_BAN, SA_REMBANS, SA_MASTERMODE, SA_AUTOTEAM, SA_FORCETEAM, SA_GIVEADMIN, SA_MAP, SA_RECORDDEMO, SA_STOPDEMO, SA_CLEARDEMOS, SA_SERVERDESC, SA_SHUFFLETEAMS, SA_FRIENDLY_FIRE, SA_NUM};
...
enum { FF_DISABLED = 0, FF_ENABLED = 1, FF_NUM }; // friendly fire
...
#define FTXT__CERTFILENAME  (FTXT_MAPNAME | FTXT_TOLOWER)
