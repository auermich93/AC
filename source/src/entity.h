...
public:
    ...
    int frags, flagscore, deaths, tks, damage;
    ...
    playerent() : curskin(0), clientnum(-1), lastupdate(0), plag(0), ping(0), address(0), lifesequence(0), frags(0), flagscore(0), deaths(0), tks(0), damage(0), lastpain(0), lastvoicecom(0), lastdeath(0), clientrole(CR_DEFAULT),
    ...
    void startmap()
    {
        frags = flagscore = deaths = lifesequence = tks = damage = 0;
    }
};
